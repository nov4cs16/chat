                        ...
                        <div className="flex">
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <Link className="flex flex-row justify-center items-center" href={route('home')}>
                                    ...
                                    <div className="bg-blue-600 text-white font-bold text-3xl py-1.5 px-1.5 mr-1 rounded">
                                        SRD
                                    </div>
                                    <span className="text-3xl text-gray-700 font-semibold">forums</span>
                                </Link>
                            </div>
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                {isAdmin &&
                                    <NavLink href={route('admin.panel.forums')} active={route().current('admin.panel')}>
                                        Admin panel
                                    </NavLink>
                                }
                            </div>
